...
(1, 'Milm', 'Tests', '2019-12-10', 'milmtest12@mailmail.com', 'milmtest12', 'on', 2147483647, 'Tekukur', 'pengguna'),
(2, 'admin', 'admin', '2019-12-02', 'admin@localhost.com', 'admin', 'laki-laki', 518313122, 'Server', 'admin'),
