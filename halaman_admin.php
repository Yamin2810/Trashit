...
<head>
    ...
    <title>Admin Trashit| Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="form_organisasi.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    ...
                                    <p>Add New Organisation ID</p>
                                </div>
                                <div class="icon">
                                <i class="icon ion-md-contacts"></i>
                                </div>
                                <a href="form_organisasi.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2019 TrashIt</a>.</strong> All rights reserved.
            <div class="float-right d-none d-sm-inline-block">
                <b>Version</b> 1.0-rc.1
            </div>
        </footer>
