...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2019 at 05:44 AM
...
INSERT INTO `user_order` (`order_id`, `nama`, `jenis_order`, `alamat`, `berat`, `status`) VALUES
(1, 'Test', 'Mesin Cuci', 'Testtest', 20, 'Terima'),
(2, 'Testo', 'Kulkas', 'Testalamat', 30, 'Tunggu');
