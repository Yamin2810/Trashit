                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Formulir Pick Up</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="proses-simpanpick.php" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputname">Nama</label>
                                            <input type="text" class="form-control" name="nama" readonly value="<?php echo $_SESSION["user_fname"]?>" required="true">
                                        </div>
                                        <div class="form-group"><br>
                                            ...
                                            <option>Notebook dan Tablet</option>
                                            <option>Laptop dan PC</option>
                                            <option>Tv And Screen</option>
                                            <option>Plug and Cable</option>
                                            <option>Mesin Cuci</option>
                                          </select>
                                        </div>
                                        <div class="form-group">
                                            <label>alamat</label>
                                            <input type="text" class="form-control" name="alamat" placeholder="Alamat Penjemputan">
                                        </div>
